...
\ingredients{%
	...
	\unit[1-2]{tsp} & salt \\
	\unit[\nicefraction{1}{4}]{tsp} & black pepper \\
	\unit[\nicefraction{1}{2}]{tsp} & oregano \\
	\unit[1]{medium} & onion \\
	\unit[1]{clove} & garlic \\
	\unit[1]{package} & beyond ground beef \\
	4 & eggs \\
	\unit[\nicefraction{1}{2}]{cup} & neutral oil \\
	\unit[\nicefraction{1}{4}]{cup} & flour \\
}
\preparation{
	...
	\step Blend the can of peeled tomatoes. Optionally you can add jalapenos to the blender as well. Pour the blended tomatoes into a small pot.
	\step Add salt, peper, and other spices as you like to the blended tomatoes. Bring up to heat, but do not boil.
	...
	\step Separate the egg whites from the egg yolks. Combine the egg whites in a large bowl and whisk until you reach soft peaks. Slowly add the yolks to the whipped egg whites.
	...
	\step One at a time, dunk a stuffed poblano into the flour then into the egg mixture, then place into the frying oil. Flip after about 3-4 minutes, or when slightly browned and crispy, then fry for an additional 2-3 minutes until both sides are well cooked.
...
\begin{recipe}
	\ingredients{%
		\unit[1]{package} & spaghetti \\
		\unit[6]{large} & poblano peppers \\
		\unit[1]{cup} & onion \\
		\unit[2]{cloves} & garlic \\
		\unit[1]{cup} & milk \\
		\unit[1\nicefraction{1}{2}]{cup} & heavy cream \\
		\unit[4]{tsp} & bouillon \\
		\unit[1\nicefraction{1}{2}]{cup} & corn \\
	}
	\preparation{%
